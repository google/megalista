...
class FileDataSource(BaseDataSource):
    ...
    def _get_data_source(self, file_type: str):
        ...
        if file_type == 'PARQUET':
            return ParquetDataSource(self._is_transactional, self._dataflow_options, self._destination_type)
        elif file_type == 'CSV':
            return CSVDataSource(self._is_transactional, self._dataflow_options, self._destination_type)
