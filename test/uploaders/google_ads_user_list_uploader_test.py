...
from utils.execution import Execution, OriginType, Action
...
def test_fail_having_more_than_one_execution(mocker):
  ...
  exec1 = Execution('orig1', OriginType.BIG_QUERY, ('dt1', 'buyers'), Action.ADS_USER_LIST_UPLOAD, 'dest1',
                    ('a', 'b', 'c'))
  exec2 = Execution('origi2', OriginType.BIG_QUERY, ('dt2', 'buyers2'), Action.ADS_USER_LIST_UPLOAD, 'dest2',
                    ('a', 'b', 'c'))
...
def test_fail_missing_destination_metadata(uploader):
  execution = Execution('orig1', OriginType.BIG_QUERY, ('dt1', 'buyers'), Action.ADS_USER_LIST_UPLOAD, 'dest1',
                        ('a', 'b'))
